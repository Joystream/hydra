...
{% hint style="info" %}
Before starting, make sure`hydra-cli`is [installed](install-hydra.md) on your machine together with all the prerequisites. Use @joystream/hydra-cli@next version to use the latest features.
{% endhint %}
