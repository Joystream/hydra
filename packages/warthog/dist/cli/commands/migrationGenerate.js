...
exports.default = {
    ...
    run: function (toolbox) { return __awaiter(void 0, void 0, void 0, function () {
        var db, options, error, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    db = toolbox.db, options = toolbox.parameters.options, error = toolbox.print.error;
                    if (!options.name) {
                        return [2 /*return*/, error('"name" option is required')];
                    }
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, db.generateMigration(options.name)];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
