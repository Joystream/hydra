...
function createLiveNetworks(t: TFunction): LinkOption[] {
  return [
    ...
    },
    {
      ...
      textBy: t(
        'rpc.ava.summary',
        'user-run public nodes; see https://status.cloud.ava.do/',
        { ns: 'apps-config' }
      ),
    ...
    },
    {
      ...
      textBy: t('rpc.hosted.by', 'hosted by {{host}}', {
        ns: 'apps-config',
        replace: { host: 'Commonwealth Labs' },
      }),
    ...
    },
    {
      ...
      textBy: t('rpc.hosted.by', 'hosted by {{host}}', {
        ns: 'apps-config',
        replace: { host: 'Stake Technologies' },
      }),
...
function createTestNetworks(t: TFunction): LinkOption[] {
  return [
    ...
    {
      info: 'equilibrium',
      text: t('rpc.equilibriumtestnet', 'Equilibrium Testnet', {
        ns: 'apps-config',
      }),
      textBy: t('rpc.hosted.by', 'hosted by {{host}}', {
        ns: 'apps-config',
