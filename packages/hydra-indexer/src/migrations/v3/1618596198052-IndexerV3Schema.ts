...
export class IndexerV3Schema1618596198052 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "substrate_event" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "created_by_id" character varying NOT NULL DEFAULT 'hydra-indexer', "updated_at" TIMESTAMP DEFAULT now(), "updated_by_id" character varying, "deleted_at" TIMESTAMP, "deleted_by_id" character varying, "version" integer NOT NULL, "id" character varying NOT NULL, "name" character varying NOT NULL, "section" character varying, "extrinsic_name" character varying, "extrinsic_hash" character varying, "extrinsic_index" integer, "method" character varying NOT NULL, "phase" jsonb NOT NULL, "block_number" integer NOT NULL, "block_hash" character varying NOT NULL, "block_timestamp" bigint NOT NULL, "index_in_block" integer NOT NULL, "params" jsonb NOT NULL, "data" jsonb NOT NULL, "extrinsic_id" character varying, "block_id" character varying, CONSTRAINT "PK_eb7d4a5378857e4a4e82fb6e16d" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
